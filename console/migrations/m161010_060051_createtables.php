...
class m161010_060051_createtables extends Migration
{
    public function up()
    {
        ...
        $this->createTable('SD_pc2machine', [
            ...
            'p_ordertime' => $this->datetime()->notNull(),
            'p_sendouttime' => $this->datetime()->notNull(),
            'p_responsetime' => $this->datetime()->notNull(),
            'p_responsevalue' => $this->string(16)->notNull(),
            'p_execflag' => $this->string(16)->notNull(),
        ...
        $this->createTable('SD_machine', [
            ...
            'm_firmware' => $this->string(64)->notNull(),
            'm_usercount' => $this->smallinteger()->notNull(),
            'm_tmpcount' => $this->smallinteger()->notNull(),
            'm_signcount' => $this->smallinteger()->notNull(),
            'm_ipaddress' => $this->string(64)->notNull(),
            'm_fpversion' => $this->string(64)->notNull(),
            'm_faceversion' => $this->string(64)->notNull(),
            'm_needfaceamount' => $this->smallinteger()->notNull(),
            'm_facecount' => $this->smallinteger()->notNull(),
            'm_functionflag' => $this->string(8)->notNull(),

            'm_stamp' => $this->string(32)->notNull(),
            'm_opstamp' => $this->string(32)->notNull(),
            'm_errordelay' => $this->smallinteger()->notNull(),
            'm_delay' => $this->smallinteger()->notNull(),
            'm_transtimes' => $this->string()->notNull(),
            'm_transinterval' => $this->string()->notNull(),
            'm_transflag' => $this->string()->notNull(),
            'm_realtimetrans' => $this->string(8)->notNull(),
            'm_encrypt' => $this->string(8)->notNull(),
